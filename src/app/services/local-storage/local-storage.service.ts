...
export class LocalStorageService {
  ...
  public set setFiatCurrenciesPriceUSD(data: {prices: Array<{code: FiatCurrencies, priceUSD: number}>, date: Date}) {
  ...
  public get getFiatCurrenciesPriceUSD(): {prices: Array<{code: FiatCurrencies, priceUSD: number}>, date: Date} {
    ...
    if (fiatCurrenciesPriceUSD !== null) {
      return JSON.parse(fiatCurrenciesPriceUSD) as {prices: Array<{code: FiatCurrencies, priceUSD: number}>, date: Date};
    }
